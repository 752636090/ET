...
namespace ET
{
    public class OnGenerateCSProjectProcessor : AssetPostprocessor
    {
        ...
        {
            content = content.Replace("    <Reference Include=\"Editor\">\r\n      <HintPath>Assets\\Editor\\Dll\\Editor.dll</HintPath>\r\n    </Reference>", string.Empty);
            ...
            {
                content =  content.Replace("<Compile Include=\"Assets\\Editor\\Code\\Empty.cs\" />", string.Empty);
                content =  content.Replace("<None Include=\"Assets\\Editor\\Code\\Unity.Editor.asmdef\" />", string.Empty);
            }
            ...
            if (path.EndsWith("Unity.Editor.csproj"))
            {
                return GenerateCustomProject(path, content, @"Codes\Editor\**\*.cs");
            }
