    ...
    public static class Game
    {
        ...
        public static Scene Scene
        {
            get
            {
...
#if UNITY_EDITOR
                var editorAssembly = AppDomain.CurrentDomain.GetAssemblies().First(a => a.GetName().Name == "Editor");
                ...
                if (!UnityEngine.Application.isPlaying)
                {
                    editorAssembly.GetType("ET.EditorEntityLauncher").GetMethod("AfterCreateScene").Invoke(null, new object[] { scene });
                }
#endif
                return scene;
            }
