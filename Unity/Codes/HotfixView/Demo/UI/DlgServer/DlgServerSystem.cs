...
namespace ET
{
	...
	[FriendClass(typeof(Scroll_Item_serverTest))]
	public static  class DlgServerSystem
	{
		...
		public static void RegisterUIEvent(this DlgServer self)
		{
			...
			self.View.E_ServerListLoopVerticalScrollRect.AddItemRefreshListener((tranform, index) => { self.OnSrollItemRefreshHandler(tranform, index); });
		}
		...
		public static void OnSrollItemRefreshHandler(this DlgServer self, Transform transform, int index)
        {
