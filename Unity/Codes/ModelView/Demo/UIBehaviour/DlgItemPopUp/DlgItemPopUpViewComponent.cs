		...
		public UnityEngine.UI.Image E_QualityImage
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_QualityImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"ItemBackGroup/TopGround/Item_bagItem/E_Quality");
     			}
		...
		public UnityEngine.UI.Image E_IconImage
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_IconImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"ItemBackGroup/TopGround/Item_bagItem/E_Quality/E_Icon");
     			}
