namespace ET
{
    ...
    public static class AccountSessionsComponentSystem
    {
        ...
        public static void Add(this AccountSessionsComponent self, long accoutId, long sessionInstanceId)
        {
            if (self.AccountSessionDictionary.ContainsKey(accoutId))
            {
                self.AccountSessionDictionary[accoutId] = sessionInstanceId;
                return;
            }
            self.AccountSessionDictionary.Add(accoutId, sessionInstanceId);
        }
